# Star Cars Management Reference App (SCM) WinForms C#

![SCMWinForms](./Media/SCMWINFORMS.png)

# About the App
Star Cars Management (SCM) is a reference App create to show some of the migration capabilities of the [Visual Basic Upgrade Companion](https://www.mobilize.net/visual-basic-upgrade-companion) [VBUC](https://www.mobilize.net/visual-basic-upgrade-companion) from [Mobilize.Net](https://www.mobilize.net)

This repo contanins the migrated [SCM VB6 Version](https://github.com/MobilizeNet/SCMVB6)
...
```
git clone https://github.com/MobilizeNet/SCMWinForms.git
```
...
![frmLogin](./Media/Login.PNG)

![frmAddNewBrand](./Media/AddBrand.PNG)

![frmDeleteVehicle](./Media/DeleteVehicle.PNG)

![frmViewStaff](./Media/ViewStaff.PNG)
